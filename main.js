// main.js - TerraSoil Regenerative Agriculture Consulting Firm Shared JavaScript Logic
...
function initBackToTop() {
  ...
  btn.id = 'back-to-top';
  btn.className = 'fixed bottom-6 right-6 rtl:right-auto rtl:left-6 w-12 h-12 rounded-xl bg-brand-primary hover:bg-brand-primaryHover text-white flex items-center justify-center shadow-lg shadow-emerald-600/20 hover:shadow-emerald-600/35 transition-all duration-300 transform translate-y-10 opacity-0 pointer-events-none z-50';
